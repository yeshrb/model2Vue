...
public interface GroovyParserVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code normalExprAlt}
	 * labeled alternative in {@link GroovyParser#statementExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitNormalExprAlt(GroovyParser.NormalExprAltContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitEnhancedExpression(GroovyParser.EnhancedExpressionContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitClosurePrmrAlt(GroovyParser.ClosurePrmrAltContext ctx);
	/**
	 ...
	 * @return the visitor result
	 */
	T visitLambdaPrmrAlt(GroovyParser.LambdaPrmrAltContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code typePrmrAlt}
	 * labeled alternative in {@link GroovyParser#primary}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTypePrmrAlt(GroovyParser.TypePrmrAltContext ctx);
	/**
