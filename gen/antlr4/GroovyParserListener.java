...
public interface GroovyParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code normalExprAlt}
	 * labeled alternative in {@link GroovyParser#statementExpression}.
	 * @param ctx the parse tree
	 */
	void enterNormalExprAlt(GroovyParser.NormalExprAltContext ctx);
	/**
	 * Exit a parse tree produced by the {@code normalExprAlt}
	 * labeled alternative in {@link GroovyParser#statementExpression}.
	 * @param ctx the parse tree
	 */
	void exitNormalExprAlt(GroovyParser.NormalExprAltContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link GroovyParser#enhancedExpression}.
	 * @param ctx the parse tree
	 */
	void enterEnhancedExpression(GroovyParser.EnhancedExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link GroovyParser#enhancedExpression}.
	 * @param ctx the parse tree
	 */
	void exitEnhancedExpression(GroovyParser.EnhancedExpressionContext ctx);
	/**
	 ...
	 * @param ctx the parse tree
	 */
	void enterClosurePrmrAlt(GroovyParser.ClosurePrmrAltContext ctx);
	/**
	 * Exit a parse tree produced by the {@code closurePrmrAlt}
	 * labeled alternative in {@link GroovyParser#primary}.
	 * @param ctx the parse tree
	 */
	void exitClosurePrmrAlt(GroovyParser.ClosurePrmrAltContext ctx);
	/**
	 * Enter a parse tree produced by the {@code lambdaPrmrAlt}
	 * labeled alternative in {@link GroovyParser#primary}.
	 * @param ctx the parse tree
	 */
	void enterLambdaPrmrAlt(GroovyParser.LambdaPrmrAltContext ctx);
	/**
	 * Exit a parse tree produced by the {@code lambdaPrmrAlt}
	 * labeled alternative in {@link GroovyParser#primary}.
	 * @param ctx the parse tree
	 */
	void exitLambdaPrmrAlt(GroovyParser.LambdaPrmrAltContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code typePrmrAlt}
	 * labeled alternative in {@link GroovyParser#primary}.
	 * @param ctx the parse tree
	 */
	void enterTypePrmrAlt(GroovyParser.TypePrmrAltContext ctx);
	/**
	 * Exit a parse tree produced by the {@code typePrmrAlt}
	 * labeled alternative in {@link GroovyParser#primary}.
	 * @param ctx the parse tree
	 */
	void exitTypePrmrAlt(GroovyParser.TypePrmrAltContext ctx);
	/**
